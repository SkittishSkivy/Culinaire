...
execute if predicate cul:block/fungal_composter/has_fungus run tag @s add cul.block.fungal_composter.move_to.fungus
execute as @s[tag=cul.block.fungal_composter.move_to.fungus] unless data block ~ ~ ~ Items[{Slot:3b}] run item replace block ~ ~ ~ container.0 with air
execute as @s[tag=cul.block.fungal_composter.move_to.fungus] unless data block ~ ~ ~ Items[{Slot:3b}] run item replace block ~ ~ ~ container.3 from entity @s weapon.mainhand

item replace entity @s weapon.mainhand from block ~ ~ ~ container.0
execute if predicate cul:block/fungal_composter/input run tag @s add cul.block.fungal_composter.move_to.input
execute as @s[tag=cul.block.fungal_composter.move_to.input] unless data block ~ ~ ~ Items[{Slot:5b}] run item replace block ~ ~ ~ container.0 with air
execute as @s[tag=cul.block.fungal_composter.move_to.input] unless data block ~ ~ ~ Items[{Slot:5b}] run item replace block ~ ~ ~ container.5 from entity @s weapon.mainhand
item replace entity @s weapon.mainhand with air

tag @s remove cul.block.fungal_composter.move_to.fungus
tag @s remove cul.block.fungal_composter.move_to.input
...
execute if data block ~ ~ ~ Items[{Slot:6b}] run data modify storage cul:main temp.Item set from block ~ ~ ~ Items[{Slot:4b}]
execute if data block ~ ~ ~ Items[{Slot:6b}] run function cul:block/spit_item
...
execute if data block ~ ~ ~ Items[{Slot:12b}] run data modify storage cul:main temp.Item set from block ~ ~ ~ Items[{Slot:12b}]
execute if data block ~ ~ ~ Items[{Slot:12b}] run function cul:block/spit_item
