item replace entity @s armor.head with minecraft:leather_horse_armor{CustomModelData:8520034}

tag @s remove cul.block.pan.egg_1
tag @s add cul.block.pan.egg_2
