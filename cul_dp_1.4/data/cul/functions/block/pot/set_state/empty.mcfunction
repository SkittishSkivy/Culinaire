...
execute as @s[tag=cul.block.pot.cheese_soup] run loot give @p[tag=cul.interact.player] loot cul:item/soup/cheese_soup
...
execute as @s[tag=cul.block.pot.terracotta_chipped] if predicate cul:random/1_percent run function cul:block/pot/terracotta_crack/cracked
execute as @s[tag=cul.block.pot.terracotta] if predicate cul:random/1_percent run function cul:block/pot/terracotta_crack/chipped
