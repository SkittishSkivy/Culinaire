...
execute as @s[tag=!cul.block.pot.heated] run item replace entity @s armor.head with minecraft:leather_horse_armor{CustomModelData:8520011}

data modify entity @s HandItems[0].tag.display.color set value 461318

tag @s remove cul.block.pot.empty
tag @s add cul.block.pot.kelp_mush
