...
execute as @s[tag=cul.block.pot.terracotta_chipped] run loot spawn ~ ~1 ~ loot cul:item/chipped_terracotta_pot
execute as @s[tag=cul.block.pot.terracotta_chipped] run particle block terracotta ~ ~1.25 ~ 0.1 0.1 0.1 0.1 10
execute as @s[tag=cul.block.pot.terracotta_chipped] run playsound minecraft:block.stone.break block @a

execute as @s[tag=cul.block.pot.terracotta_cracked] run loot spawn ~ ~1 ~ loot cul:item/cracked_terracotta_pot
execute as @s[tag=cul.block.pot.terracotta_cracked] run particle block terracotta ~ ~1.25 ~ 0.1 0.1 0.1 0.1 10
execute as @s[tag=cul.block.pot.terracotta_cracked] run playsound minecraft:block.stone.break block @a
