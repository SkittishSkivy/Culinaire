item replace entity @s armor.head with minecraft:leather_horse_armor{CustomModelData:8520052}

tag @s remove cul.block.pan.rice_1
tag @s add cul.block.pan.rice_2
