...
execute as @s[tag=cul.block.clam.spit_item] positioned ~ ~1 ~ run summon minecraft:item ~ ~ ~ {Age:-32768,PickupDelay:15,Tags:["clockwork.tick","cul.clam_item"],Item:{id:"minecraft:stone_button",Count:1b}}
