execute as @s[tag=cul.block.salt_pillar.normal] run loot spawn ~ ~1 ~ loot cul:item/salt_pillar/normal
...
execute as @s[tag=cul.block.salt_pillar.log] run loot spawn ~ ~1 ~ loot cul:item/salt_pillar/log
execute as @s[tag=cul.block.salt_pillar.turtleback] run loot spawn ~ ~1 ~ loot cul:item/salt_pillar/turtleback
...
execute as @s[tag=cul.block.salt_pillar.grown] if predicate cul:random/10_percent run loot spawn ~ ~1.25 ~ loot cul:item/salt_shard
